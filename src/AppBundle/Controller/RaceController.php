...
class RaceController extends Controller implements ClassResourceInterface
{
     ...
     *     @SWG\Parameter(name="distance", type="int", in="formData", description="The distance of the race in metres."),
     ...
     *     @SWG\Parameter(name="date", type="string", in="formData", description="The date of the race (yyyy-MM-dd)"),
